...
def plot_case(N):
    ...
    file_spmm   = f"result__spmm_f64_n{N}.txt"
    file_aspt   = f"result_ASpT_spmm_f64_n{N}.txt"
    file_swift  = f"results_Swift_FP64_{N}.txt"
    output_fig  = f"timecompare_full_f64_n{N}.png"
