...
while read lineA <&3 && read lineB <&4; do
    ...
    col11B=$(echo "$lineB" | awk '{print $15}') #blk ratio
...
awk '{if($8!=0) res=$9/$8; else res="N/A"; print $0, res}' $output_file8 > tmp && mv tmp $output_file8

awk '$10 <= 100' $output_file8 > $output_file
