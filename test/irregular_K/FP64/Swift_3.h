                          ...
                          double *d_resultmtx)
{
    ...
    int *rowidx_sh = sh;
    double *val_sh = (double *)&rowidx_sh[(blockDim.y << 5)];
...
//    cudaStream_t stream1, stream2;
 ...
 //   cudaStreamCreate(&stream2);    
    ...
    if(tilenum !=0 && h_reside_nnz !=0 && width % 32 ==0)
    {
        ...
        Swift_GPU_3<<<dim3((tilenum+8-1)/8,(width+31)/32,1),dim3(32,8,1),32*8*(sizeof(int)+sizeof(double)),0>>>(rowA, colA,          
                                               width, nnz,
                                               tilenum,
                                               d_tile_ptr,
                                               d_tile_colidx,
    ...
    {
        printf("Swift GPU (3.0) SpMM Check NO PASS! error = %d \n", error_Swift_spmm);
        time_Swift_gpu = -1;
    }
