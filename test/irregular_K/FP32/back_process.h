...
void row_idx_sort(slide_matrix *matrix, float *dense_mtx,int rowA, int colA, int width, float &blockratio)
{
    ...
    int fulltile = tilenum%8==0 ? tilenum/8 : tilenum/8 +1;
    blockratio = float(nonsamecount) / float(fulltile);     
