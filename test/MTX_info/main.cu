...
//|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-
    ...
    int longele = rowA %32 == 0 ? rowA/32 : rowA/32 +1;
    int widele = colA %32 == 0 ? colA/32 : colA/32 +1;
    long sumofit = (long) longele * widele;
    int *arrayfordist = (int *)malloc(sizeof(int)*sumofit);
    if (arrayfordist == NULL) {
    printf("malloc failed!\n");
    return;
}
    memset(arrayfordist,0,sizeof(int)*sumofit);
    int errorindex =0;
    int errorptr2 = 0;
    ...
    for(int i=0; i<rowA; i++)
    {
        ...
        {
            int col = csrcolidx[j];
            long index =(long) (i/32)*widele + (long)(col/32);
            arrayfordist[index]++;
    ...
    double ratio2 = double(emptyBlk) / double(sumofit);
    ...
    if(error_cusparse_spmm !=0)
    {
        ...
        time_cusparse_spmm = -1;
        time_cusparse_spmm_pre = -1;
    }
    else
    {
...
time_balance = (tbalance2.tv_sec - tbalance1.tv_sec) * 1000.0 + (tbalance2.tv_usec - tbalance1.tv_usec) / 1000.0;
    ...
    row_idx_sort(matrixA,sort_dense_mtx1,rowA,colA,BN, block_ratio);
    ...
    double ratio = double(nnz) / double((long long)rowA * colA);
    
    if (time_final1 != -1)
    {
        printf("success Swift SpMM,Time process:%f ms sparsity %f empty block ratio %f\n", time_final1,ratio,ratio2);
        FILE *fout = fopen(RESULT_FILE_PATH, "a");
        if (fout == NULL)
            printf("Writing results fails.\n");
        fprintf(fout, "%s m %d n %d width %d nnz %d cuSPARSE: %f sparsity %f emptyblkratio %f final %f \n",
            filename,rowA, colA, BN, nnz, time_cusparse_spmm,ratio,ratio2 ,time_final1);
        fclose(fout);
